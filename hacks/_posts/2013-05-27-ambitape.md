...
![FIXME: Photo of the AmbiTape in action!!!!!]()

AmbiTape is companion software for the [BlinkyTape](/blinkytape).  It allows you
to add interactive backlighting to your computer monitor.

AmbiTape is based on Adafruit's [Adalight](http://learn.adafruit.com/adalight-diy-ambient-tv-lighting/choosing-leds)
...
![BlinkyTape attached to outside of monitor with clear tape]()
...
![Twisted BlinkyTape attached to back of monitor w/ double sided tape]()

**Benefits**: Easy to install.  Easy to remove.  Projects light against the wall.

**Drawbacks**: Requires creasing the BlinkyTape.  Results in a "dead" at each
turn due to pixels pointing in toward the monitor.
...
![BlinkyTape folded to make a 90&deg; turn]()

![BlinkyTape 90&deg; fold, back side view]()

![Folded BlinkyTape, attached to monitor with double-sided tape]()
...
<a name="mapping"></a>
## Mapping Your Display (Estimated Time: 20 minutes)
...
![AmbiTape preview of LED mapping]()
